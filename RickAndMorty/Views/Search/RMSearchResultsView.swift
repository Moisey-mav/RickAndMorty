...
protocol RMSearchResultsViewDelegate: AnyObject {
    func rmSearchResultsView(_ results: RMSearchResultsView, didTapLocationAt index: Int)
    func rmSearchResultsView(_ results: RMSearchResultsView, didTapCharacterAt index: Int)
    func rmSearchResultsView(_ results: RMSearchResultsView, didTapEpisodeAt index: Int)
}
